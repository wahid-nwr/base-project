...
public class PatientSearchUtils
{
	...
	public static String prepareSqlQuery( HttpServletRequest request)
	{
		...
		String projectSqlQuery = " SELECT a.componentId, a.uniqueCode, a.description  FROM Patient a";
	...
	public static ArrayList<String> getColumnHeader()
	{
		...
		columnHeader.add("label.patient.description"); 
		columnHeader.add("label.patient.last.updatedby"); 
		return columnHeader;
	}
