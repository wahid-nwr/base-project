...
Ext.DatePicker = Ext.extend(Ext.Component, {
    ...
    update : function(date){
        ...
        //console.log("this.internalRender::"+(this.internalRender));
        if(!this.internalRender){
            ...
            //console.log("this.el.getBorderWidth(\"lr\")::"+this.el.getBorderWidth("lr"));
            ...
            if(Ext.isOpera && !this.secondPass){
                ...
                //console.log("isopera::"+main.rows[0].cells[1].style.width);
...
Ext.SplitButton = Ext.extend(Ext.Button, {
    ...
    autoWidth : function(){
        if(this.el){
            ...
            //console.log('tbl width::'+tbl.getWidth()+tbl2.getWidth())
    ...
    updateChildSize : function(){
        if(this.resizeChild){
            ...
            if(el.dom.offsetWidth){
                ...
                //console.log("child width::"+b.width+adj[0]);
...
Ext.extend(Ext.tree.TreeLoader, Ext.util.Observable, {
    ...
    doPreload : function(node){
        if(node!=null && node.attributes.children){
...
Ext.extend(Ext.menu.Menu, Ext.util.Observable, {
    ...
    createEl : function(){
        ...
        if(w){
            ...
            el.setWidth(parseInt(ul.getWidth())+parseInt(el.getFrameWidth("lr")));
        }
    },
