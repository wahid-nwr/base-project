    ...
    Ext.lib.Dom = {
        ...
        getXY : function(el) {
            ...
            if (el.getBoundingClientRect) {
            	//console.log("in getBoundingClientRect");
                b = el.getBoundingClientRect();
                scroll = fly(document).getScroll();
                //console.log("in getBoundingClientRect::b.left::"+b.left+" scroll.left::"+scroll.left+" b.top::"+b.top+" scroll.top::"+scroll.top);
            ...
            //console.log("in hasAbsolute::"+hasAbsolute+" p::"+p);
            while (p) {
        ...
        setXY : function(el, xy) {
            ...
            //console.log("el id:::"+el+" "+el.position());
            if (xy!=null && xy[0] !== false) {
                el.dom.style.left = pts.left + "px";
            }
            if (xy!=null && xy[1] !== false) {
        ...
        proto.setRuntimeAttribute = function(attr) {
            if (this.patterns.points.test(attr)) {
                ...
                if (isset(attributes['points']['from'])) {
                	...
                	//console.log('is not set'+el);
                	//console.log('is not set'+Ext.lib.Dom.getXY(el));
