...
public class CASSubAlgorithmDTO extends PersistentCapableDTO
{
	// algorithm id
	...
	private String prevAlgQuestionId;
	...
	public String getPrevAlgQuestionId ( )
	{
		return prevAlgQuestionId;
	}

	public void setPrevAlgQuestionId ( String prevAlgQuestionId )
	{
		this.prevAlgQuestionId = prevAlgQuestionId;
	}
