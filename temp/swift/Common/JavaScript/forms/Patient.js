...
function getPatientAddForm(tabpanel,store)
{
	...
	({
        url:    'patientAction.csmp?method=addPatient',
        id:     'patientAddForm',
        layout: 'form',
...
function getFieldSet()
{
	var fieldSet = [{ xtype: 'hidden',name:'componentId', fieldLabel: 'componentId' },
	        { xtype: 'textfield',name:'patientId', fieldLabel: 'patientId' }, 
			{ xtype: 'textfield',name:'name', fieldLabel: 'name' }, 
			{ xtype: 'datefield',name:'birthDate',fieldLabel: 'birthDate',emptyText:'Enter Date',format:'Y-n-d H:i'}, 
			{ xtype: 'numberfield',name:'age',fieldLabel: 'age',emptyText:'0'}, 
...
function loadFormData(form,row)
{
	...
	form.findField('name').setRawValue(row.data.name);
	form.findField('birthDate').setRawValue(row.data.birthdate);
...
function getPatientStore()
{
	var store = new Ext.data.Store({
        ...
        reader: new Ext.data.XmlReader({
               ...
               {name: 'patientid', mapping: 'ItemAttributes > patientid'},
               'componentId',
               'name',
			   'birthdate',
			   'age',
